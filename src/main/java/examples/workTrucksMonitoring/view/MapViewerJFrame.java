...
public class MapViewerJFrame extends javax.swing.JFrame {
    ...
    public void updateMultipleRoutes(List<List<GeoPosition>> allRoutes) {
        List<Painter<JXMapViewer>> painters = new ArrayList<>();

        for (List<GeoPosition> route : allRoutes) {
            RoutePainter painter = new RoutePainter(route); // folosește RoutePainter-ul tău
